...
(function (global, factory) {
    ...
    var UpgradeNg1ComponentAdapterBuilder = (function () {
        ...
        UpgradeNg1ComponentAdapterBuilder.prototype.extractBindings = function () {
            ...
            if (btcIsObject && Object.keys(this.directive.scope).length) {
                throw new Error("Binding definitions on scope and controllers at the same time are not supported.");
            }
    ...
    var UpgradeAdapter = (function () {
         ...
         *   - `controllers`: supported. (NOTE: injection of `$attrs` and `$transclude` is not supported.)
