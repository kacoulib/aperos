 ...
 *
 * A directive consists of a single directive annotation and a controllers class. When the
 ...
 * the directive
 * controllers is correctly instantiated on the `<template>` element rather than the `<li>` element.
 *
 * ## Lifecycle hooks
 *
